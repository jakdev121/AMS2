...
(1, 'SMK PGRI 2 JOMBANG', 'NgeSurat', 'Chunin', 'Jl. Halmahera No.14 , RT/RW 14/05 , Kaliwunggu , Jombang ', 'Uchiha Madara', '-', 'http://www.smkpgri2jombang.sch.id', 'admin@smkpgri2jombang.com', 'surat.png', 1);
...
(2, 1, 'Siswa', '420 / 015 /SMK PGRI 2 JBG/VIII/2015', 'Surat edaran untuk mengikuti kegiatan sholat Idhul Adha di sekolah.', '421.6', '2015-08-28', '2016-07-24', '', 'Wajib', 5),
(3, 2, 'Darmaji, S.T. (Guru)', '421 / 056 SMK PGRI 2 JBG/ XII /2015', 'Surat tugas untuk menghadiri undangan Penganugerahan Bursa Khusus SMK', '421', '2015-12-07', '2016-07-24', '', '-', 5),
...
(5, 4, 'Guru', '042/067 /SMK PGRI 2 JBG/I/2016', 'Surat undangan rapat dinas koordinasi ujian sekolah\r\n', '421', '2016-02-01', '2016-07-24', '', 'Wajib Hadir', 5);
...
(11, 1, '001/PPH/VI/2016', 'Pondok Pesantren Hidayatullah Nganjuk', 'Permohonan Zakat Fitrah', '421.7', 'A.1', '2016-06-09', '2016-07-24', '', 'Penting', 5),
(12, 2, '074 / BAZNAZ.JTM / IV / 2016', 'Badan Amil Zakat Nasional Provinsi Jawa Timur', 'Pencairan Dana Bantuan Sebesar Rp. 800.000,- (Delapan Ratus Ribu Rupiah) dari Baznaz.', '422.4', 'A.2', '2016-04-07', '2016-07-24', '', 'Penting', 5),
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Qomaruddin Rozzaq', '-', 1),
...
--
ALTER TABLE `tbl_user`
  MODIFY `id_user` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;COMMIT;
